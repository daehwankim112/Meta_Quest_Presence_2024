// David Kim 5/1/2024
// Description: Network OVRSkeleton using NetworkBehaviour
...
public class NetworkOVRSkeleton : NetworkBehaviour
{
    ...
    protected virtual void InitializeBones()
    {
        ...
        for (int i = 0; i < _bones.Count; ++i)
        {
            ...
            Assert.IsTrue((int)bone.Id >= 0 && bone.Id <= (OVRSkeleton.BoneId)BoneId.Max);
            ...
            if (bone.Transform == null)
            {
                ...
                bone.Transform = GetBoneTransform((NetworkOVRSkeleton.BoneId)bone.Id);
                if (bone.Transform == null)
                {
                    bone.Transform = new GameObject(BoneLabelFromBoneId((OVRSkeleton.SkeletonType)_skeletonType, (NetworkOVRSkeleton.BoneId)bone.Id)).transform;
                }
            }

            // if allocated bone here before, make sure the name is correct.
            if (GetBoneTransform((NetworkOVRSkeleton.BoneId)bone.Id) == null)
            {
                bone.Transform.name = BoneLabelFromBoneId((OVRSkeleton.SkeletonType)_skeletonType, (BoneId)bone.Id);
            }
    ...
    private void InitializeBindPose()
    {
        ...
        for (int i = 0; i < _bindPoses.Count; ++i)
        {
            ...
            Transform trans = bindPoseBone.Transform
                ...
                : (bindPoseBone.Transform =
                    new GameObject(BoneLabelFromBoneId((OVRSkeleton.SkeletonType)_skeletonType, (BoneId)bindPoseBone.Id)).transform);
            ...
            for (int i = 0; i < _capsules.Count; ++i)
            {
                ...
                if (capsule.CapsuleRigidbody == null)
                {
                    capsule.CapsuleRigidbody =
                        new GameObject(BoneLabelFromBoneId((OVRSkeleton.SkeletonType)_skeletonType, (BoneId)bone.Id) + "_CapsuleRigidbody")
                ...
                if (capsule.CapsuleCollider == null)
                {
                    capsule.CapsuleCollider =
                        new GameObject(BoneLabelFromBoneId((OVRSkeleton.SkeletonType)_skeletonType, (BoneId)bone.Id) + "_CapsuleCollider")
    ...
    protected void UpdateSkeleton()
    {
        ...
        for (var i = 0; i < _bones.Count; ++i)
        {
            ...
            else if (IsHandSkeleton(_skeletonType))
            {
                ...
                if ((NetworkOVRSkeleton.BoneId)_bones[i].Id == BoneId.Hand_WristRoot)
                {
    ...
    public static string BoneLabelFromBoneId(OVRSkeleton.SkeletonType skeletonType, BoneId boneId)
    {
        ...
        else if ((NetworkOVRSkeleton.SkeletonType)skeletonType == SkeletonType.FullBody)
        {
            switch (boneId)
            {
        ...
        else if (IsHandSkeleton((SkeletonType)skeletonType))
        {
            switch (boneId)
            {
                case (BoneId)OVRSkeleton.BoneId.Hand_WristRoot:
                    return "Hand_WristRoot";
                case (BoneId)OVRSkeleton.BoneId.Hand_ForearmStub:
                    return "Hand_ForearmStub";
                case (BoneId)OVRSkeleton.BoneId.Hand_Thumb0:
                    return "Hand_Thumb0";
                case (BoneId)OVRSkeleton.BoneId.Hand_Thumb1:
                    return "Hand_Thumb1";
                case (BoneId)OVRSkeleton.BoneId.Hand_Thumb2:
                    return "Hand_Thumb2";
                case (BoneId)OVRSkeleton.BoneId.Hand_Thumb3:
                    return "Hand_Thumb3";
                case (BoneId)OVRSkeleton.BoneId.Hand_Index1:
                    return "Hand_Index1";
                case (BoneId)OVRSkeleton.BoneId.Hand_Index2:
                    return "Hand_Index2";
                case (BoneId)OVRSkeleton.BoneId.Hand_Index3:
                    return "Hand_Index3";
                case (BoneId)OVRSkeleton.BoneId.Hand_Middle1:
                    return "Hand_Middle1";
                case (BoneId)OVRSkeleton.BoneId.Hand_Middle2:
                    return "Hand_Middle2";
                case (BoneId)OVRSkeleton.BoneId.Hand_Middle3:
                    return "Hand_Middle3";
                case (BoneId)OVRSkeleton.BoneId.Hand_Ring1:
                    return "Hand_Ring1";
                case (BoneId)OVRSkeleton.BoneId.Hand_Ring2:
                    return "Hand_Ring2";
                case (BoneId)OVRSkeleton.BoneId.Hand_Ring3:
                    return "Hand_Ring3";
                case (BoneId)OVRSkeleton.BoneId.Hand_Pinky0:
                    return "Hand_Pinky0";
                case (BoneId)OVRSkeleton.BoneId.Hand_Pinky1:
                    return "Hand_Pinky1";
                case (BoneId)OVRSkeleton.BoneId.Hand_Pinky2:
                    return "Hand_Pinky2";
                case (BoneId)OVRSkeleton.BoneId.Hand_Pinky3:
                    return "Hand_Pinky3";
                case (BoneId)OVRSkeleton.BoneId.Hand_ThumbTip:
                    return "Hand_ThumbTip";
                case (BoneId)OVRSkeleton.BoneId.Hand_IndexTip:
                    return "Hand_IndexTip";
                case (BoneId)OVRSkeleton.BoneId.Hand_MiddleTip:
                    return "Hand_MiddleTip";
                case (BoneId)OVRSkeleton.BoneId.Hand_RingTip:
                    return "Hand_RingTip";
                case (BoneId)OVRSkeleton.BoneId.Hand_PinkyTip:
